...
def seed_users():
    ...
    user7 = User(username='Jhalsa', email='jaystar@aa.io', password='password',profile_img="https://images.unsplash.com/photo-1488426862026-3ee34a7d66df?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80",property_type="Residential", phone_number="5102997616", city="New York", state="NY", zipcode="94203", is_pm=True)
    user8 = User(username='Yan Can Cook', email='yancancook@aa.io', password='password',profile_img="https://images.unsplash.com/photo-1544168190-79c17527004f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=776&q=80",property_type="Residential", phone_number="5102997617", city="San Jose", state="CA", zipcode="94503", is_pm=True)
