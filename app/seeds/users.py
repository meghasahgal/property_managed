...
def seed_users():
    demo = User(username='Demi', email='marnie@aa.io', password='password', pm_tagline="Doing My Best To Get You a Great ROI",profile_img="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Nnx8cHJvcGVydHklMjBtYW5hZ2VyfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=800&q=60",property_type="Residential", pm_rate="15", phone_number="5102997611", city="Sacramento", state="CA", zipcode="94203", avg_rating="4", is_pm=True)
    user2 = User(username='Lucas', email='lucas@aa.io', password='password', pm_tagline="Doing My Best To Get You a Great Deal!",profile_img="https://images.unsplash.com/photo-1651390601043-d0f963ba8d27?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTF8fGFyYWIlMjBwcm9mZXNzaW9uYWwlMjBtYW58ZW58MHx8MHx8&auto=format&fit=crop&w=800&q=60",property_type="Residential",pm_rate="10", phone_number="5102997618", city="Newark", state="CA", zipcode="94203", avg_rating="4",is_pm=True)
    user3 = User(username='Bill', email='bill@aa.io', password='password', pm_tagline="Doing My Best To Get You a Great Run For Your Investment!",profile_img="https://images.unsplash.com/photo-1554774853-719586f82d77?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OHx8cmVhbCUyMGVzdGF0ZSUyMGFnZW50fGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=800&q=60",property_type="Commercial",pm_rate="20", phone_number="5102997612", city="Los Angeles", state="CA", zipcode="90001", avg_rating="5",is_pm=True)
    user4 = User(username='Elma', email='elmo@aa.io', password='password',profile_img="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Nnx8cHJvcGVydHklMjBtYW5hZ2VyfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=800&q=60",property_type="Commercial", phone_number="5102997613", city="Sacramento", state="CA", zipcode="94203", is_pm=True)
    user5 = User(username='Jason', email='bigbirde@aa.io', password='password',pm_tagline="I'll Work Hard For You!",profile_img="https://images.unsplash.com/photo-1594744803329-e58b31de8bf5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MzJ8fHdvbWFufGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=2000&q=60",property_type="Retail", phone_number="5102997614", city="Los Angeles", state="CA", zipcode="94203", is_pm=True)
    user6 = User(username='Alyssa', email='cookiemonster@aa.io', password='password',pm_tagline="Eagle Eye for a Good ROI",profile_img="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Nnx8cHJvcGVydHklMjBtYW5hZ2VyfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=800&q=60",property_type="Residential", phone_number="5102997615", city="Sacramento", state="CA", zipcode="94203", is_pm=True)
    user7 = User(username='Jhalsa', email='jaystar@aa.io', password='password',pm_tagline="Sharp Eye for a Good ROI", profile_img="https://images.unsplash.com/photo-1488426862026-3ee34a7d66df?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80",property_type="Residential",pm_rate="10", phone_number="5102997616", city="New York", state="NY", zipcode="94203", is_pm=True)
    user8 = User(username='Yan', email='yancancook@aa.io', password='password',pm_tagline="Guaranteed Run For Your Money!",profile_img="https://images.unsplash.com/photo-1544168190-79c17527004f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=776&q=80",property_type="Residential",pm_rate="15", phone_number="5102997617", city="San Jose", state="CA", zipcode="94503", is_pm=True)
